...
/*
void findSurfaces(PointCloud::Ptr cloud){
...
void display(){
    ...
    cloud_filtered = cm->getCloud();
    //cloud_filtered = statisticalFilter( cloud_filtered );
    cloud_filtered = makeVoxelGrid( cloud_filtered );
